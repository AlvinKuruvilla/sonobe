...
use folding_schemes::zcash::merkle_tree::MerkleTreeCircuit;
...
fn main() {
    ...
    // assert_eq!(z_0.len(), 5);
    let f_circuit = MerkleTreeCircuit::<Fr>::new(()).unwrap(); // Ensure to use Fq here
    ...
    pub type N =
        Nova<G1, GVar, G2, GVar2, MerkleTreeCircuit<Fr>, KZG<'static, Bn254>, Pedersen<G2>>;
